...
import {
  ...
  BarChart3, Lightbulb, Settings2, Menu, X, Crown, EyeOff,
} from 'lucide-react'
  ...
  return (
    <div className="flex h-screen bg-slate-50 dark:bg-slate-950 overflow-hidden">
      ...
      >
        ...
        <div className="p-3 border-t border-slate-800">
          ...
          <div className="flex items-center gap-3 px-3 py-2">
            ...
            {isPro && (
              <span className="text-xs font-bold px-1.5 py-0.5 rounded-full text-white" style={{ background: 'var(--ios-blue)' }}>
                PRO
              </span>
            )}
          </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="lg:hidden flex items-center gap-3 px-4 py-3 bg-white dark:bg-slate-900 border-b border-slate-100 dark:border-slate-800">
          ...
          <div className="flex items-center gap-2">
            ...
            {privacyMode && (
              <span className="flex items-center gap-1 text-xs text-[var(--ios-orange)] font-medium">
      ...
      <nav
        ...
        className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-700 flex items-center justify-around px-2"
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive ? 'text-[var(--ios-blue)]' : 'text-slate-400',
              )}
              aria-current={isActive ? 'page' : undefined}
            >
              <Icon className="w-5 h-5 shrink-0" aria-hidden="true" />
